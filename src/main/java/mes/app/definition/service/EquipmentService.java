...
public class EquipmentService {
	...
	public List<Map<String, Object>> getEquipmentOrderNum(String orderNum) {
		...
		String sql = """
        		select er.id
        		, FORMAT(er."StartDate", 'yyyy-mm-dd') as start_date_only
                , FORMAT(er."EndDate", 'yyyy-mm-dd') as end_date_only
                , FORMAT(er."StartDate", 'yyyy-mm-dd hh24:mi') as start_date
			    , FORMAT(er."EndDate", 'yyyy-mm-dd hh24:mi') as end_date
	            , e."Name"
	            , e."Code"
	            , er."StartDate"
	            , FORMAT(er."StartDate",'HH24:MI') as "StartTime"
